...
export const dropdownLabel = __(
  'The GitRepo user to which the Jira user %{jiraDisplayName} will be mapped',
);
...
export const tableConfig = [
  ...
  {
    key: 'gitlabUsername',
    label: __('GitRepo username'),
  },
];

export const userMappingMessage = __(`Jira users have been imported from the configured Jira
  instance. They can be mapped by selecting a GitRepo user from the dropdown in the "GitRepo username"
